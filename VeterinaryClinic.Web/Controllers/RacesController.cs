...
namespace VeterinaryClinic.Web.Controllers
{
    public class RacesController : Controller
    {
        ...
        public RacesController(VeterinaryClinicContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdRace,NameRace,Description")] Race race)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdRace,NameRace,Description")] Race race)
        {
            if (id != race.IdRace)
            {
                return NotFound();
