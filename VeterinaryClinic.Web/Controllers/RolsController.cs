...
namespace VeterinaryClinic.Web.Controllers
{
    public class RolsController : Controller
    {
        ...
        public RolsController(VeterinaryClinicContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdRol,NameRol,Description")] Rol rol)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdRol,NameRol,Description")] Rol rol)
        {
            if (id != rol.IdRol)
            {
                return NotFound();
